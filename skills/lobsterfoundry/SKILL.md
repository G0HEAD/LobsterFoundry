...
- `scripts/improvement.py` -- Improvement submissions
...
- Set `LOBSTER_BASE_URL` (or `LOBSTER_SERVER`) to override the server URL.
- `lobster.py register` can also accept `--public-key` or `--public-key-file`.
